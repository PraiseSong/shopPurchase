...
$lang = array_merge($lang,array(
	...
	"ACCOUNT_USERNAME_IN_USE"		=> "用户名： %m1% 已存在，请更换其它名称",
	"ACCOUNT_DISPLAYNAME_IN_USE"		=> "小店名： %m1% 已存在，请更换其它名称",
	"ACCOUNT_EMAIL_IN_USE"			=> "邮箱： %m1% 已存在，请更换其它邮箱",
